...
- **Tenant ID** — The partner's Microsoft 365 [tenant](/docs/glossary/glossary) identifier (a GUID). Useful when cross-referencing with Entra ID directly.
...
- **MFA Trust** — Whether your tenant trusts [multi-factor authentication](/docs/glossary/glossary) claims from this partner. Displays as enabled or disabled.
- **B2B Direct Connect** — Shows whether inbound or outbound [B2B Direct Connect](/docs/glossary/glossary) is active for this partner.
- **Guest Count** — The number of guest users from this partner currently in your tenant.
- **Policy Status** — Whether [cross-tenant access policies](/docs/concepts/cross-tenant-policies) are explicitly configured for this partner, or whether the tenant default applies.
...
Click on any partner row to open their full [partner details](/docs/partners/partner-details) page, which includes cross-tenant access policy configuration, associated guest users, trust score breakdown, and activity history.
